        ...
        return (
            <section className="News_Details" >
                ...
                {/* <div className="news_content">
                    <div className="Details_1">
                        <h1 className="titles">
                            王珂不慎暴露破产的真实原因，网友：终于知道刘涛为何不离不弃了
                        </h1>
                        <div className="author_info">
                            <span className="avater">
                                <img className="images" src="https://p3.pstatp.com/thumb/2c66001ab3ed00cd7fc6"/>
                            </span>
                            <span className="names">
                                <div>
                                    <span className="srcName">乐乐里</span>
                                    <img src="https://s3b.pstatp.com/growth/mobile_detail/image/toutiaohao_tag.1vygyFaw.svg"/>
                                </div>
                                <div>
                                    <span className="times">2小时前</span>
                                    <span className="dot"></span>
                                    <span className="comment">116评论</span>
                                </div>
                            </span>
                            <a className="btn">关注</a>
                        </div>
                    ...
                    <div className="Details_2">
                        <div>
                            ...
                            <p className="text_1 bgimg">
                                <span>
                                    <img className="conImg" src="https://p3.pstatp.com/large/50a50004135b29d4de18"/>
                                </span>
                            </p>
                            <p className="text_1 bgimg">
                                <span>
                                    <img className="conImg" src="https://p3.pstatp.com/large/50a700014317c7f02244"/>
                                </span>
                            </p>
                            <p className="text_1">
                            说起王珂刘涛两人的婚姻，怎么说也有10年之久了吧，还记得前段时间王珂对刘涛的态度引来很多人的方案，而如今王珂在喝醉之后说了一句这样的话。他说：“年的时间，我从不让别人进入我们的生活，也不愿意有人叫我哥，因为这个责任承担起来太大了！”
